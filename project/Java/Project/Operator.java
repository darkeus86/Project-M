...
import Project.InProgress;
import Project.SendReport;
...
public class Operator extends WebFrame {
    ...
    Operator()
    {
        ...
        java.awt.MenuBar.exit.addActionListener(new ActionListener() {
            @Override
        ...
        java.awt.MenuBar.logout.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                setVisible(false);
                main(null);
        ...
        java.awt.MenuBar.makeReport.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                SendReport.launch();
            }
